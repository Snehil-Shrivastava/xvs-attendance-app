...
//       if (status === "Late") {
//         cats.late.push(rec);
//       } else if (status === "Grace Used") {
//         // Legacy value still possible on older docs
...
//       }
//       // Absent / WFH / Holiday intentionally not shown in the 5 categories
//     }
...
//                       <button
//                         type="button"
//                         // onClick={() => onViewAttendance?.(rec.userId)}

//                         onClick={() => {
//                           if (onViewAttendance) onViewAttendance(rec.userId);
//                           else router.push(`/team?expand=${rec.userId}`);
//                         }}
