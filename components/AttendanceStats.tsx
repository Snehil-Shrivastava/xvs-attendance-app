...
//   currentMonth: string; // Passed from parent (e.g. "2026-08")
// }
...
//     // Fetch stats for the selected month dynamically
...
//   const halfDaysCount = String(stats?.halfDays ?? 0).padStart(2, "0"); // Placeholder / Live value
...
//           ) : (
//             <div className="flex justify-center items-center gap-1 my-auto">
//               <h3 className="font-calSans text-white text-3xl md:text-4xl leading-none">
//                 {overtimeMins}
//               </h3>
...
const AttendanceStats = ({ currentMonth }: AttendanceStatsProps) => {
  ...
  return (
    <div className="w-full font-poppins">
      <div className="flex gap-2.5">
        {/* CARD 1: LATE (RED) */}
        <div className="border border-[#E5DEC9] bg-transparent py-4 px-2 flex flex-col items-center justify-between text-center flex-[0.65] gap-0.5 min-h-[95px]">
          <span className="text-black text-[9px] tracking-wide font-semibold">
            Late
          </span>
          {isLoading ? (
