...
//           {/* Employee Name */}
//           <h2 className="text-xl font-calSans tracking-wider">
...
//           {/* Today's date goes here in format of 24 Aug or 08 Sept */}
//         </span>
//         <span className="text-[10px] tracking-[14px]">
//           {/* Current year goes here */}
//         </span>
//       </div>
//     </div>
//   );
